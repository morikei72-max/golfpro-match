...
//
// 【2026/5/25 更新】
//   - LINE連携成功時のメッセージを Flex Message(MyCoachに戻るボタン付き)に変更
//   - お客様/コーチごとに戻り先URLを切り替え
...
// 【2026/5/25 更新】LINE連携成功時を Flex Message(戻るボタン付き)に変更
// ============================================
async function handleVerificationCode({ code, lineUserId, supabase }) {
  ...
  // ============================================
  // 【2026/5/25 追加】LINE連携成功時の Flex Message
  // 「MyCoach に戻る」緑ボタン付き
  // ============================================
  ...
  const buttonLabel = user_type === 'customer'
    ? '🏌 MyCoach に戻る'
    : '🏌 コーチ画面に戻る';
